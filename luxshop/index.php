...
$query_banner = "SELECT * FROM banner WHERE status = 1";
$banner = mysqli_query($conn, $query_banner);
...
//query product
$query_product = "SELECT * FROM product WHERE status = 1 AND featured = 1 || featured = 2";
...
<head>
	...
	<!-- font google -->
	<link href="https://fonts.googleapis.com/css?family=Cinzel:400,700,900|Roboto+Condensed:300,300i,400,400i,700,700i&amp;subset=vietnamese" rel="stylesheet">
	<!--===============================================================================================-->	
		...
		<div class="wrap-slick1">
			<div class="slick1">
				<?php foreach ($banner as $slider) : 
					$content = explode(',', $slider['content']);
					?>

					<div class="item-slick1" style="background-image: url(<?= $slider['images'] ?>);">
						<div class="container h-full">
							<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
								<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
									<span class="ltext-101 cl2 respon2">
										<span class="text-capitalize"><?= $content[0]; ?></span>
									</span>
								</div>

								<div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
									<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">
										<span class="text-uppercase"><?= $content[1]; ?></span>
									</h2>
								</div>
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52 ">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10 txt-center">
					...
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item cat-<?= $pro['category_id'] ?> ">
						...
						<div class="block2">
							...
							<div class="block2-pic hov-img0">
								<img src="<?= $pro['images']; ?>" alt="IMG-PRODUCT">

								<a href="product-detail.php?idPro=<?= $pro['id']; ?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
									<!-- js-show-modal1 -->
									Xem ngay
								</a>
							</div>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="product-detail.php?idPro=<?= $pro['id']; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										<?= $pro['name']; ?>
									</a>
									...
									<span class="stext-105 cl3">
										<?php if ($pro['sale_price'] > 0) { ?>
											...
											<strike class="mr-2"><?= number_format($pro['price'],0,',','.'); ?></strike>
											<span><?= number_format($pro['sale_price'],0,',','.'); ?></span> VNĐ
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						263B- Hoàng Quốc Việt- Cầu Giấy- Hà Nội
					</p>
					<p class="stext-107 cl7 size-201">
						Hotline : 012321392
					</p>
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<p class="stext-102 cl3 p-t-23">
								Sản phẩm được làm từ chất liệu tốt nhất....
							</p>
