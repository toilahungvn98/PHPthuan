                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                ...
                                <h4>Đăng nhập </h4>
                                <form method="POST">
                                    <?php       include 'admin/myAdmin/functions/check_input.php';
                                    $errors = [];
                                    ...
                                    if (!empty($_POST['mailUser'])) {
                                        ...
                                        $sqlcheck = "SELECT * FROM customer WHERE email ='$mailUser' AND password = '$PassUser' ";
                                ...
                                <div class="form-group">
                                    <label>Email </label>
                                    <input type="email" class="form-control" name="mailUser" placeholder="...">
                                </div>
                                <div class="form-group">
                                    <label>Mật khẩu</label>
                                    <input type="password" class="form-control"  name="PassUser" placeholder="...">
                                </div>
                                <div class="checkbox">
                                     <!--    <label>
                                       ...
                                       <!--  <label class="pull-right">
                                        ...
                                        <div class="register-link m-t-15 text-center">
                                            <p>Bạn chưa có tài khoản ? <a href="page-register.php"> Đăng ký tại đây</a></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
